...
CUDA_VISIBLE_DEVICES=1 /home/jishen/my_torch/install/bin/th main.lua -scale 3 -netType Dense3 -nFeat 64 -nFeaSDB 64 -nDenseBlock 16 -nDenseConv 8 -growthRate 64 -patchSize 128 -dataset flickr2k -datatype t7  -DownKernel BI -splitBatch 4 -trainOnly false  -save /data/jishen/torch/model3_16 -gpuid 1 -upsample deconv -preTrained ../experiment/model/RDN_BIX2.t7 2>&1 | tee $LOG
